...
## 痛点描述
作者是一个运动爱好者，在学习和生活当中平衡锻炼计划，常常出现一些令人烦恼的问题。
...
并且，试着将深圳大学的本地化信息融入agent的资料库当中，agent可以通过tool调取深圳大学的场地、器材乃至食堂的信息，为深圳大学的学生输出超本地化的智能规划。

例如，agent可以知道学校健身房被体育课占用的时间，以及什么时候人较多，器材容易被占用导致排队。

食堂的饮食推荐，agent可以根据用户的生活费预算，结合用户的健身目标进行客制化，规划每天摄入的蛋白质、碳水、脂肪的量，以及具体去哪个食堂吃。

天气系统通过调取实时的天气，推测体育场馆是否可以利用，同时根据天气调整计划。
